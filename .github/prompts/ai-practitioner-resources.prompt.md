This is the original prompt used to generate the AI Practitioner Resources list. It's been replaced by the JSON-specific prompt .github\prompts\ai-practitioner-resources-json.prompt.md
